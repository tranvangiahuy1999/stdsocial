...
const PersonalPage = (props) => {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener(
        "scroll",
        debounce(handleInfiniteOnLoad, 2000)
      );
  }, [id]);
  ...
  async function getPersonalNewfeed(page) {
    ...
    axiosInstance
      .get(`/newfeed/yourfeed/${userid}/${page}`)
      .then((res) => {
        if (res.data.code === 0) {
            ...
            {changeUsernameState ? (
              <div>
                <input
                  ...
                  onChange={(e) => setChangeUsernameText(e.target.value)}
                ...
                <FaRegSave
                  ...
                  className="clickable-icon-dark ml-2 text-primary"
                  size="22px"
                ></FaRegSave>
                <AiOutlineClose
                  onClick={() => setChangeUsernameState(false)}
                  className="clickable-icon-dark ml-2 text-danger"
                  size="22px"
                ></AiOutlineClose>
              </div>
            ) : (
              <div>
                ...
                {isYour && (
                  <FaRegEdit
                    onClick={changeUsernameHandle}
                    className="clickable-icon-dark ml-2"
                    size="22px"
                    color="white"
                  ></FaRegEdit>
                )}
          ...
          {isYour && (
            <div className="row">
              <AiFillCamera
                ...
                className="clickable-icon-dark mt-2"
                color="white"
                size="24px"
              ></AiFillCamera>
              <input
              ...
              {previewFile && (
                <div className="row" style={{ padding: "2px" }}>
                  <AiOutlineCheck
                    className="clickable-icon-dark mt-2 text-primary"
                    onClick={uploadAvatar}
                    size="20px"
                  ></AiOutlineCheck>
                  <AiOutlineClose
                    className="clickable-icon-dark ml-2 mt-2 text-danger"
        ...
        <div className="row pt-4">
          <div className={width < 768 ? "col-12" : "col-4"}>
            <div className="intro-zone">
              <div className="component-title">Introduce</div>
              <div>
                  ...
                  <div>
                    ...
                    <div>
                      <div style={{ color: "gray", fontWeight: "500" }}>
                        {personalInfo && personalInfo.faculty[0]
                          ? personalInfo.faculty[0]
                          : `Not set`}
                      </div>
                    </div>
                  </div>
                ...
                <div className="m-2 row" style={{ fontSize: "16px" }}>
                  ...
                  <div>
                    ...
                    <div>
                      <div style={{ color: "gray", fontWeight: "500" }}>
                        {personalInfo && personalInfo.birth
                          ? personalInfo.birth
                          : `Not set`}
                      </div>
                    </div>

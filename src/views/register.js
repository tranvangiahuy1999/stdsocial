    ...
    <div className="col-md-12 containerr" style={{ flex: 1 }}>
      <div className="img-bg d-flex justify-content-center">
        <div
          className={
            width < 768
              ? "form-container col-12 p-4 m-2 d-flex justify-content-center align-self-center"
              : "form-container col-5 p-4 m-2 d-flex justify-content-center align-self-center"
          }
        >
          <Form
            className="login-form col-10 m-5"
            labelCol={{
              span: 10,
            }}
            wrapperCol={{
              ...
              >
                {falcutyData && falcutyData.length > 0 ? (
                  falcutyData.map((value, index) => (
                    ...
                    <Select.Option key={index} value={value.nameRole}>
                      {value.nameRole}
                    </Select.Option>
                    // )
                  ))
